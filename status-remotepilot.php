...
$sql=mysqli_query($conn, "SELECT * FROM remotepilot WHERE nrrp='$_GET[nrrp]'");
$rp=mysqli_fetch_assoc($sql);
  ...
  <div class="container">
    <div class="row flex-center pt-4 pb-lg-9 pb-xl-0">
      <div class="mb-3 col-lg-8 pb-2 pt-6  text-center">
        <h1 class="text-white fw-light">Status <span class="text-danger fw-bold">Keanggotaan</span></h1>
            ...
            <div class="text-center">
              <?php if(mysqli_num_rows($sql) < 1){ ?>
                <div class="alert alert-danger">
                    <strong>Maaf, Data keanggotaan tidak valid..!</strong><br>
              ...
              <?php }else{ ?>
                ...
                <p>NRRP <br/> <span style="font-size: 1.5em;"> <b> <?php echo $rp['nrrp']; ?></b> </span></p>
                <img src="assets/pasfoto/<?php echo $rp['gambar']; ?>" alt="Foto <?php echo $rp['nama_rp']; ?>" width="250px">
                <hr>
                <p class="fs-2">Sertifikat yang dimiliki</p>
                <?php
                  $sertifikat = mysqli_query($conn,"SELECT * FROM sertifikat WHERE remotepilot='$rp[nrrp]'");
                ...
                ?>
                <p><span style="font-size: 1.5em;"> <b>Sertifikat <?= $p['nama_kelas']; ?></b> </span></p>
              <?php }; ?>
              <?php }; ?>
            </div>
